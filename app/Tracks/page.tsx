...
const gridContainerVariants = {
  hidden: { opacity: 4, scale: 0, x: 150, y: 100 },
  show: {
    opacity: 1,
    scale: 1,
    x: 0,
...
const Tracks = () => {
  return (
    <div className=" flex flex-col items-center justify-center mt-16 gap-16 ">
      <div className="intro  flex flex-col-reverse lg:flex-row items-center justify-center">
        <div className="intro-state  flex flex-col lg:flex-row text-[#481DA6]">
          <div className=" flex flex-col items-center justify-center gap-[24px] lg:items-start lg:gap-4 intro-main-text lg:w-[512px] lg:h-[256px]">
            <div className="place-items-center md:w-[512px]">
              <motion.h1
                initial={{ opacity: 0.4, y: -150 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 4 }}
                className="lg:text-[48px]/[56px] text-center gap-8 lg:text-start text-[40px]/[48px] w-[340px] h-[144px] lg:w-[512px] lg:h-[112px] font-[600]"
              >
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 4 }}
                className="lg:text-[16px]/[20px] text-[16px]/[24px] text-center lg:text-start"
              >
      ...
      <div className="coding-tracks flex flex-col">
        <div className="coding-header flex  gap-7 mb-8 flex-col w-[340px] h-[232px] md:w-[712px] md:h-[146px] lg:w-[1200px] lg:h-[152px] text-center font-[600]">
          <motion.h1
            ...
            transition={{ duration: 4 }}
            className="coding-title-intro text-[24px]/[32px] md:text-[32px]/[36px] lg:text-[40px]/[48px]"
          >
            {CODINGTRACKS.title}
          </motion.h1>
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="show"
          className="tracks grid lg:grid-cols-2 gap-[16px] md:gap-[24px] place-items-center lg:text-start lg:place-items-start"
        >
          {CODINGTRACKS.courses.map((course: any, index: number) => {
            return (
              <motion.div
                variants={gridContainerVariants}
                key={course.id}
                className="lg:w-[512px] lg:h-[288px] md:w-[512px] md:h-[248px] w-[340px] flex flex-col items-center justify-center gap-[16px]"
              >
      ...
      <div className="nocoding-tracks flex flex-col mt-2">
        <div className="nocoding-header flex  gap-7 flex-col w-[340px] h-[232px] md:w-[712px] md:h-[146px] lg:w-[1200px] lg:h-[152px] text-center font-[600]">
          <motion.h1
            initial={{ opacity: 0, x: 6, z: 4 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 8 }}
            className="nocoding-title-intro text-[24px]/[32px] md:text-[32px]/[36px] lg:text-[40px]/[48px]"
          >
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="show"
          className="tracks grid lg:grid-cols-2 gap-[16px] md:gap-[24px] place-items-center text-center lg:text-start lg:place-items-start"
        >
      ...
      <div className="place-items-center">
                ...
                <div className="rounded-[24px] sub-1  w-[340px] h-[514px] lg:w-[584px] lg:h-[612px] lg:bg-[#E6EBFF] md:h-[612px] md:w-[584px] md:bg-[#E6EBFF] bg-[#ECF3FB]">
                  <div className="header ml-5  flex flex-col gap-4">
                    ...
                    <motion.div
                      ...
                      whileInView={{ opacity: 1, x: 0 }}
                      transition={{ duration: 4 }}
                      className="header-text w-[537px] h-[36px] text-start text-[32px]/[36px] font-[500]"
                    >
                  ...
                  <div className="flex items-center justify-center gap-2 md:gap-3  h-[415px]">
                    <div className="big bg-white  justify-evenly w-[134px] h-[310px] rounded-[8px] lg:h-[324px] lg:w-[256px] md:h-[324px] md:w-[256px]">
                      <motion.div className="devr flex flex-col items-center justify-center lg:h-[78.17px] lg:w-[231px]">
                        <motion.div
                          initial={{ opacity: 0.4, y: -150 }}
                          whileInView={{ opacity: 1, y: 0 }}
                          transition={{ duration: 4 }}
                        ...
                        <motion.div
                          initial={{ opacity: 0.4, y: 250 }}
                          whileInView={{ opacity: 1, y: 0 }}
                          transition={{ duration: 4 }}
                          className="devr-text text-[18px]/[30px] font-[400] text-center"
                        >
                  ...
                  <div className="flex flex-col items-center justify-evenly ggg md:flex-row w-[340px] h-[256px] md:w-[585px] md:h-[209px] lg:w-[585px] lg:h-[209px] ">
                    <div className="flex flex-col gap-0 items-start -mt-9 gggg">
                      ...
                      <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 4 }}
                        className="header-text text-start text-[32px]/[36px] font-[500]"
                      >
        ...
        <div className="bonus text-[14px]/[20px] font-[600] mt-4 text-center lg:text-start">
          ...
          >
            ...
            <div className="text-1 mt-3 lg:mt-4 text-start w-[308px] h-[44px] md:w-[345px] md:h-[72px]">
              <div className="subtitle-1 my-2 font-[500]  md:text-[20px]/[28px] md:font-[600]">
                {PROGRAMMESCOMPONENT.cards[0].title}
              </div>
              <div
                dangerouslySetInnerHTML={{
                  __html: PROGRAMMESCOMPONENT.cards[0].description,
                }}
                className="description-1 text-[14px]/[20px] md:text-[18px]/[24px] font-[400] "
              />
            </div>
          </motion.div>
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 4 }}
            className="MID-2 shadow-2xl flex flex-col items-center w-[340px] h-[326px] md:w-[380px] md:h-[364px] lg:h-[372px] rounded-[24px]"
          >
            ...
            <div className="text-2 mt-3 lg:mt-4 text-start w-[308px] h-[44px] md:w-[345px] md:h-[72px]">
              <div className="subtitle-2 my-2 font-[500]  md:text-[20px]/[28px] md:font-[600]">
                {PROGRAMMESCOMPONENT.cards[1].title}
              </div>
              <div
                dangerouslySetInnerHTML={{
                  __html: PROGRAMMESCOMPONENT.cards[1].description,
                }}
                className="description-2 text-[14px]/[20px] md:text-[18px]/[24px] font-[400] "
              />
            </div>
          </motion.div>
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 4 }}
            className="MID-3 shadow-2xl flex flex-col items-center w-[340px] h-[326px] md:w-[380px] md:h-[364px] lg:h-[372px] rounded-[24px]"
          >
            ...
            <div className="text-3 mt-3 lg:mt-4 text-start w-[308px] h-[44px] md:w-[345px] md:h-[72px]">
              <div className="subtitle-3 my-2 font-[500]  md:text-[20px]/[28px] md:font-[600]">
                {PROGRAMMESCOMPONENT.cards[2].title}
              </div>
              <div
                dangerouslySetInnerHTML={{
                  __html: PROGRAMMESCOMPONENT.cards[2].description,
                }}
                className="description-3 text-[14px]/[20px] md:text-[18px]/[24px] font-[400] "
              />
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-[340px] md:w-[600px] flex flex-col items-center justify-center gap-8">
        ...
        >
          <Button
            className="text-center text-white bg-[#481DA6] w-[136px] h-[48px] rounded-[4px] md:rounded-none md:w-[182px] md:h-[44px] pt-[8px] pr-[16px] pb-[8px] pl-[16px]"
            label="Get started"
          />
        </motion.div>
      </div>
